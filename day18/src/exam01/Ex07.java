...
public class Ex07 {
    public static void main(String[] args) {
        ...
        System.out.printf("English : %s%n", month.getDisplayName(TextStyle.FULL, Locale.US));
        System.out.printf("English : %s%n", month.getDisplayName(TextStyle.SHORT, Locale.US));
        System.out.printf("English : %s%n", month.getDisplayName(TextStyle.NARROW, Locale.US));
